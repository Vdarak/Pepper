...
export async function GET() {
  try {
    ...
    // Get latest horizontal resistance results from last 2 days
    ...
    const { data, error } = await supabase
      ...
      .eq('pattern_type', 'horizontal_resistance')
    ...
    console.error('Error fetching horizontal resistance results:', error);
    return NextResponse.json(
